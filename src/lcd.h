...
extern void lcd_putsmAtt(uint8_t x,uint8_t y,const char_p * s,uint8_t skip,uint8_t mode);
...
extern void lcd_putsm_P(uint8_t x,uint8_t y,const char_p * s,uint8_t skip);
